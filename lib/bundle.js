  ...
  _createClass(Game, [{
    ...
    value: function draw() {
      ...
      this.pipeQueue.forEach(function (pipe, y) {
        ...
        var xPos = 9 * _board2.default.WIDTH;
        var yPos = y * _board2.default.WIDTH + 1.5 * _board2.default.WIDTH;
        _this.ctx.clearRect(xPos, yPos, _board2.default.WIDTH, _board2.default.WIDTH);
        _this.ctx.drawImage(img, xPos, yPos, _board2.default.WIDTH, _board2.default.WIDTH);
      });
    }
  }]);
